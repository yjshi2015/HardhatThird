...
/**
 * @dev ERC4626 "代币化金库标准"合约
 * 
 * @notice
 * 1.注入基础代币时，计算金库额度的公式为:assets * (share_total / assets_total)，同理，获取
 *   share金库额度时，所需要的基础代币数量为 share * (assets_total / share_total)，即保持同
 *   比例增加
 * 2.这个金库本身也是个ERC20代币，又跟基础代币保持1:1或者同比例的关系，所以它真正的用途究竟是什么
 */
